                        ...
                        <div class="col-sm-5 mb20">
                                <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                        <li data-thumb="{{asset('images/Others/Balcony Hotel- Reception.jpg')}}">
                                            <img src="{{asset('images/Others/Balcony Hotel- Reception.jpg')}}" class="img-responsive">
                                        </li>
                                        <li data-thumb="{{asset('images/Others/Balcony Hotel- Reception.jpg')}}">
                                            <img src="{{asset('images/Others/Balcony Hotel- Reception.jpg')}}" class="img-responsive">
                                        </li>
                                        
                                        <li data-thumb="{{asset('images/service/Balcony Hotel_Swimming Pool.jpg')}}">
                                            <img src="{{asset('images/service/Balcony Hotel_Swimming Pool.jpg')}}" class="img-responsive">
                                        </li>
                                        <li data-thumb="{{asset('images/service/Balcony Hotel_Swimming Pool (2).jpg')}}">
                                            <img src="{{asset('images/service/Balcony Hotel_Swimming Pool (2).jpg')}}" class="img-responsive">
                                        </li>
                                        <li data-thumb="{{asset('images/service/Balcony Hotel_Swimming Pool (3).jpg')}}">
                                            <img src="{{asset('images/service/Balcony Hotel_Swimming Pool (3).jpg')}}" class="img-responsive">
                                        </li>
                                        <li data-thumb="{{asset('images/service/Balcony Hotel_Swimming Pool (4).jpg')}}">
                                            <img src="{{asset('images/service/Balcony Hotel_Swimming Pool (4).jpg')}}" class="img-responsive">
                                        </li>
                                </ul>
                            </div>
