        ...
        <div class="hidden-lg hidden-md hidden-sm define">
            ...
            <div class="col-xs-6 sl-lang">
                ...
                <div class="dropdown mt5 dropdown-language">
                    <button class="btn btn-default dropdown-toggle" type="button" id="dd-lang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                    ...
                                    <ul class="nav-cus-menu">
                                        ...
                                        <li  class="">
                                            ...
                                            <ul class="ul-nav-child">
                                                                    ...
                                                                    <li><a href="/room/senior-deluxe-room" title="@lang('messager.ROOM3')">@lang('messager.ROOM3')</a></li>
                                                                    <li><a href="/room/deluxe-family-room" title="@lang('messager.ROOM4')">@lang('messager.ROOM4')</a></li>
                                                                    <li><a href="/room/executive-family" title="@lang('messager.ROOM5')">@lang('messager.ROOM5')</a></li>
                                                                    <li><a href="/room/balcony-signature" title="@lang('messager.ROOM6')">@lang('messager.ROOM6') </a></li>
                                                                    <li><a href="/room/triple-city-view" title="@lang('messager.ROOM7')">@lang('messager.ROOM7') </a></li>
                                                                    <li><a href="/room/king-family-suite" title="@lang('messager.ROOM8')">@lang('messager.ROOM8')</a></li>
                                            </ul>
                                        </li>
                                        <li  class="">
                                            <a>@lang('messager.SERVICES AND FACILITIES') </a>
                                            <ul class="ul-nav-child">
                                                            <li><a href="/meeting-function/Services" title="@lang('messager.SERVICES')">@lang('messager.SERVICES')</a></li>
                                                            <li><a href="/meeting-function/restaurant" title="@lang('messager.Restaurant')">@lang('messager.Restaurant')</a></li>
                                                </ul>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="ul-nav-child">
                                                            ...
                                                            <li><a href="/locations/nha-trang-speciality-can-cake" title="@lang('messager.KP3')">@lang('messager.KP3')</a></li>
                                                            <li><a href="/locations/tourist-attractions-nha-trang" title="@lang('messager.KP4')">@lang('messager.KP4')</a></li>
                                                            <li><a href="/locations/bo-nuong-lac-canh" title="@lang('messager.KP5')">@lang('messager.KP5')</a></li>
                                                            <li><a href="/locations/vinh-cam-ranh" title="@lang('messager.KP6')">@lang('messager.KP6')</a></li>
                                                            <li><a href="/locations/bai-dai" title="@lang('messager.KP7')">@lang('messager.KP7')</a></li>
                                              </ul>
                                        </li>
                                        <li  class=""><a class="" href="/gallery">@lang('messager.GALLERY')</a></li>
                                    </ul>
                                </li>
